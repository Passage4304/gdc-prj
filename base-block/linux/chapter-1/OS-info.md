...
### Краткий анализ
Операционная система Ubuntu Desktop подходит для использования на домашних и офисных компьютерах. В установке по умолчанию присутствуют офисные пакеты, стандартные утилиты, браузеры и другие подобные программы. Они закрывают большую часть задач обычного пользователя компьютера.7zip						install
...
apparmor					install
apport						install
apport-core-dump-handler			install
apport-gtk					install
...
linux-modules-extra-6.8.0-51-generic		deinstall
...
node-require-from-string			install
...
openoffice					install
openoffice-base					install
openoffice-brand-base				install
openoffice-brand-calc				install
openoffice-brand-draw				install
openoffice-brand-impress			install
openoffice-brand-math				install
openoffice-brand-ru				install
openoffice-brand-writer				install
openoffice-calc					install
openoffice-core01				install
openoffice-core02				install
openoffice-core03				install
openoffice-core04				install
openoffice-core05				install
openoffice-core06				install
openoffice-core07				install
openoffice-debian-menus				install
openoffice-draw					install
openoffice-gnome-integration			install
openoffice-graphicfilter			install
openoffice-images				install
openoffice-impress				install
openoffice-javafilter				install
openoffice-math					install
openoffice-ogltrans				install
openoffice-onlineupdate				install
openoffice-ooofonts				install
openoffice-ooolinguistic			install
openoffice-pyuno				install
openoffice-ru					install
openoffice-ru-base				install
openoffice-ru-calc				install
openoffice-ru-draw				install
openoffice-ru-help				install
openoffice-ru-impress				install
openoffice-ru-math				install
openoffice-ru-res				install
openoffice-ru-writer				install
openoffice-ure					install
openoffice-writer				install
openoffice-xsltfilter				install
...
python3-exceptiongroup				install
...
python3-trio-websocket				install
...
python3-wsproto					install
python3-xdg					install
python3-xkit					install
python3-yaml					install
python3.12					install
python3.12-dev					install
python3.12-minimal				install
python3.12-venv					install
qemu-block-extra				install
qemu-system-common				install
qemu-system-data				install
qemu-system-gui					install
qemu-system-modules-opengl			install
qemu-system-modules-spice			install
qemu-system-x86					install
qemu-utils					install
qml-module-org-kde-charts:amd64			install
qml-module-org-kde-kcoreaddons:amd64		install
...
ubuntu-mono					install
ubuntu-pro-client				install
ubuntu-pro-client-l10n				install
